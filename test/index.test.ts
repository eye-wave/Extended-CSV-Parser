...
14.491`
    ...
    const expectedOutput = [{ a: 0 }, { a: -1 }, { a: 255 }, { a: 20 }, { a: 14.491 }]
...
14.491`
    ...
    const expectedOutput = [{ a: 0 }, { a: -1 }, { a: 255 }, { a: 20 }, { a: 14 }]
...
# This is a comment`
    ...
    const expectedOutput = [
      {
        id: 1,
        user: { name: "Alice", age: 28.5, isVip: !0, gamesPlayed: ["Tetris", "Pac-Man"] },
        message: { content: "Hello how are you?", dateSend: 1648872e3 },
        nested: { property: { number: { array: [1, 2, 3, 4] } } },
        special: "😃",
      },
      {
        id: 2,
        user: { name: "Bob", age: 42, isVip: !1, gamesPlayed: [] },
        message: { content: "Hey there!", dateSend: 1648882800 },
        nested: { property: { number: { array: [5, 6, 7] } } },
        special: "🎉",
      },
      {
        id: 3,
        user: { name: "Charlie", age: 19.3, isVip: !0, gamesPlayed: ["Chess", "Checkers", "Monopoly"] },
        message: { content: "Howdy!", dateSend: 1648915200 },
        nested: { property: { number: { array: [21, 22, 23] } } },
        special: "🍺",
      },
      {
        id: 5,
        user: { name: "Hannah", age: 31.6, isVip: !1, gamesPlayed: ["Animal Crossing"] },
        message: { content: "What's new?", dateSend: 164892600024 },
        nested: { property: { number: { array: [25, 26, 27] } } },
        special: "🌺",
      },
    ]
